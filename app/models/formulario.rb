class Formulario < ActiveRecord::Base
  ...
  DISCIPLINA = ['PROFESSORA DE CRECHE','PEB1 - INFANTIL','PEB1 - FUNDAMENTAL','PEB - EDUCAÇÃO ESPECIAL','PEB2 - PORTUGUES','PEB2 - MATEMATICA','PEB2 - CIENCIAS','PEB2 - HISTÓRIA','PEB2 - GEOGRAFIA','PEB2 - INGLES','PEB2 - ARTE EDUCACAO','PEB2 - EDUCACAO FISICA']
  OPCAO = ['Selecione','MAGISTÉRIO', 'PEDAGOGIA', 'EDUCAÇÃO ESPECIAL', 'CIÊNCIAS','ARTES', 'EDUCAÇÃO FÍSICA', 'HISTÓRIA', 'GEOGRAFIA', 'LETRAS', 'MATEMÁTICA']
